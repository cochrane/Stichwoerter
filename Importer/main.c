...
#define PLUGIN_ID "08537633-AAB2-4C3A-A5B0-0C947AF8D825"
...
// -----------------------------------------------------------------------------
//	DeallocStichw_rterMDImporterPluginType
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//	Stichw_rterMDImporterPluginFactory
// -----------------------------------------------------------------------------
...
#pragma unused(allocator)
    ...
    if (CFEqual(typeID,kMDImporterTypeID)){
		CFStringRef uuidString = CFStringCreateWithCString(kCFAllocatorDefault, PLUGIN_ID, kCFStringEncodingASCII);
        uuid = CFUUIDCreateFromString(kCFAllocatorDefault, uuidString);
